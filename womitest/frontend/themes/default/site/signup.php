...
<div class="sign-bg">
	...
	<div class="sign-title"><h2>注册沃米贷</h2></div>
...
//        ],
				...
				<div class="sign">
					...
					<div class="signl">用户昵称：</div>
				</div>
				
				<div class="sign">
					<div class="sign-hide" id="sign-pass"><input  id="testalert"></input></div>
					<div class="signr" ><?= $form->field($model, 'password')->passwordInput() ?></div>
					<div class="signl">用户密码：</div>
				</div>
				
				<div class="sign">
					<div class="sign-hide" id="sign-pass"><input  id="testalert"></input></div>
					<div class="signr" ><?= $form->field($model, 'password2')->passwordInput() ?></div>
					<div class="signl">确认密码：</div>
				</div>
	...
	<a href='https://www.microriches.cn/index.php?r=site/about&about_id=protocol' target="_blank">《借贷和理财协议》</a>
					     </div>
					     <div class="gdcls"></div>
					</div>
					<div class="signl"></div>
				...
				<div class="sign">
					...
					<div class="signr">
					<?= Html::submitButton('注册', ['class' => 'sbtn btn btn-primary']) ?>
					</div>
				</div>
			<?php ActiveForm::end(); ?>
	</div>
