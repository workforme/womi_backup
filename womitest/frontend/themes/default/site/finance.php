...
<div class="borrow-i">
   ...
   <div class="index-basic">
        <div class="tr-row border ht1">
                ...
                <div class="tr-button">
                        <a href="/index.php?r=invest/list&type=sanhu"><input class="b-button" type="button" value="去申请" /></a>
                </div>
        </div>
        <div class="tr-row border ht1">
                ...
                <div class="tr-button">
                       <a href="/index.php?r=invest/list&type=womi"><input class="b-button" type="button" value="去申请" /></a>
                </div>
        </div>
   </div>
</div>
