...
<div class="borrow-i">
   ...
   <div class="index-basic">
		...
		<div class="tr-button">
			<a href="/index.php?r=loan/apply&type=qy"><input class="b-button" type="button" value="去申请" /></a>
		</div>
        </div>
        <div class="tr-row border ht1">
		...
		<div class="tr-button">
                       <a href="/index.php?r=loan/apply&type=gx"><input class="b-button" type="button" value="去申请" /></a>
                </div>
        </div>
        <div class="tr-row border ht1">
		...
		<div class="tr-button">
                        <a href="/index.php?r=loan/apply&type=ws"><input class="b-button" type="button" value="去申请" /></a>
                </div>
        </div>
